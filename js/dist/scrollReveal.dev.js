...
window.scrollReveal = function (window) {
  'use strict'; // generator (increments) for the next scroll-reveal-id
  ...
  scrollReveal.prototype = {
    ...
    init: function init() {
      this.scrolled = false;
      var self = this; //  Check DOM for the data-scrollReveal attribute
    ...
    /*=============================================================================*/
    parseLanguage: function parseLanguage(el) {
    ...
    update: function update(el) {
      ...
      if (this.isElementInViewport(el, this.options.viewportFactor)) {
        el.setAttribute('style', style + css.target + css.transition); //  Without reset enabled, we can safely remove the style tag
    ...
    genCSS: function genCSS(el) {
      ...
      var transition = "-webkit-transition: -webkit-transform " + dur + " " + easing + " " + delay + ",  opacity " + dur + " " + easing + " " + delay + ";" + "transition: transform " + dur + " " + easing + " " + delay + ", opacity " + dur + " " + easing + " " + delay + ";" + "-webkit-perspective: 1000;" + "-webkit-backface-visibility: hidden;"; //  The same as transition, but removing the delay for elements fading out.
    ...
    getViewportH: function getViewportH() {
      ...
      if (this.docElem == window.document.documentElement) return client < inner ? inner : client;else return client;
    },
    ...
    isElementInViewport: function isElementInViewport(el, h) {
